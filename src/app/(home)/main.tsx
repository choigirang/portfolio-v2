  ...
  return (
    ...
    <main id="about" className="flex justify-center w-full mt-32">
      <div className="container h-full flex-col">
        <h2 className="title sm:text-3xl md:text-xl border-solid border-b-slate-900">
          최기랑
        </h2>
        <h2 className="mt-7 font-bold text-3xl sm:text-xl md:text-base text-center drop-shadow-lg whitespace-nowrap">
          - 프론트엔드 개발자 -
        </h2>
        <p className="mt-7 text-xl sm:text-sm md:text-base text-center drop-shadow-lg text-neutral-900 leading-relaxed">
